 ...
 */
/**
 * Write a method named getBucketCount with 4 parameters. The first parameter should be named width of type double.
 ...
 */
    public static int getBucketCount(final double width, final double height, final double areaPerBucket, final int extraBuckets) {
 ...
 * If all parameters are valid, the method needs to calculate the number of buckets and return it.
 */
    public static int getBucketCount(final double width, final double height, final double areaPerBucket) {
 ...
 * If all parameters are valid, the method needs to calculate the number of buckets and return it.
 */
    public static int getBucketCount(final double area, final double areaPerBucket) {
